...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post(`${api.endpoint}/api/auth/register`, { username, email, password });
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center px-4 pt-24 flex-col">
      <div className="w-full max-w-sm bg-gray-800 p-6 rounded-lg shadow-lg">
        <div className="mb-6 text-center">
          ...
          <p className="text-sm sm:text-base text-gray-300 mt-2">
            Create your account and start chatting with Gemini Chatbot.
          </p>
        </div>
